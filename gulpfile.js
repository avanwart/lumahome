...
var revManifest = path.dist.assets + 'assets.json';
...
var cssTasks = function(filename) {
  return lazypipe()
    ...
    .pipe(function() {
      return gulpif('*.css', postcss([lost]));
    })
...
var writeToManifest = function(directory) {
  return lazypipe()
    .pipe(gulp.dest, path.dist.assets + directory)
...
gulp.task('clean', require('del').bind(null, [path.dist.assets, path.dist.templates]));
